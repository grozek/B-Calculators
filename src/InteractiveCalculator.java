 ...
 * continuing to scan user input. Can store latest result of evaluation in a character (such as
 * "a"), and then use this character as a holder for the value
 */
public class InteractiveCalculator {
    public static void main(String[] args) throws Exception {
        ...
        /*
         * Loops until a string QUIT is an input during the loop it evaluates the input
         */
        while (!input.contains("QUIT")) {
            i++;

            /*
             * if the input string contains the word "STORE" then store the input as a keyholder of
             * the latest fraction result.
             */
             ...
             * prints message to the user reminding about the proper format of input if the
             * denominator is equal to 1, then simplify it further and print nominator, else just
             * print the whole fraction
             */
            else {
