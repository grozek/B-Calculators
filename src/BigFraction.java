...
public class BigFraction {
  ...
  /**
   * Build a new fraction with numerator num and denominator denom. If the denominator is 0, then
...
/**
 * Subtrats given fractions
 * @param subtractMe BigFraction 
 ...
 */
  ...
  /**
   * multiply the two fractions by one another and return the result
   */
  ...
  /**
   * Divide two fractions by one another and return the results
   */
  ...
  /**
   * Given a BigFraction finds and returns its simplest form eq. given 2/4 returns 1/2
   */
